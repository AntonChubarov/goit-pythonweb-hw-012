...
def mock_auth_service(monkeypatch):
    ...
    monkeypatch.setattr(auth_service, "create_password_reset_token", mock_create_password_reset_token)
    monkeypatch.setattr(auth_service, "reset_password", mock_reset_password)
    monkeypatch.setattr(auth_service, "send_password_reset_email", mock_send_password_reset_email)
