...
def test_update_avatar(user_repository, mock_db_session):
    ...
    updated_user = user_repository.update_avatar(user_id=5, avatar_url="https://example.com/avatar.png")
...
def test_update_password_user_not_found(user_repository, mock_db_session):
    ...
    with pytest.raises(HTTPException) as exc_info:
        user_repository.update_password(user_id=999, hashed_password="new_hashed_password")
